...
export default function App() {
  ...
  if (conditionCode > 499 && conditionCode < 532) {
    imageUrl = `https://img.freepik.com/free-photo/weather-effects-composition_23-2149853295.jpg?w=1380&t=st=1677953183~exp=1677953783~hmac=363522694a133c9e162598953798f5950cbffcc6dd27f62d416a28ab8f62ffc5`;
  } else if (conditionCode > 800 && conditionCode < 805) {
    imageUrl = `https://images.unsplash.com/photo-1532178910-7815d6919875?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80`;
  } else if (conditionCode > 599 && conditionCode < 623) {
    imageUrl = `https://images.unsplash.com/photo-1518467946652-b194dd6dd321?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=987&q=80`;
  } else if (conditionCode === 800) {
    imageUrl = `https://wallpapercave.com/wp/wp8973745.jpg`;
  } else if (conditionCode > 199 && conditionCode < 233) {
    imageUrl = `https://images.unsplash.com/photo-1551234250-d88208c2ce14?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MTB8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60`;
